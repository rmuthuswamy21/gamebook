...
GameState _initialGame() {
  final phases = <String, GamePage>{
    ...
    'ch1_p1_first_day': GamePage(
      ...
      imageAsset: 'assets/ch1_p1_first_day.png',
      aspectRatio: 16 / 18,
    ...
    'ch4_p37_intro': GamePage(
      ...
      choices: const [
        GameChoice(
          ...
          nextId: 'ch4_p38_neuro_followup', // ➜ Neurologist follow-up
          ph: 10,
          mh: 10,
          tc: 0,
          ss: 10,
        ...
        GameChoice(
          ...
          nextId: 'ch4_p39_empty_locker', // ➜ Reflection in locker room
          ph: 20,
          mh: -5,
          tc: -10,
          ss: -5,
    ...
    'ch4_p38_neuro_followup': GamePage(
      ...
      choices: const [
        GameChoice(
          ...
          nextId: 'ch4_p39_empty_locker', // ➜ Empty locker reflection
          ph: 30,
          mh: 20,
          tc: -10,
          ss: -5,
        ...
        GameChoice(
          ...
          nextId: 'ch4_p39_empty_locker', // ➜ Same scene, different stats
          ph: -10,
          mh: -10,
          tc: 5,
          ss: 5,
